...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card encabezado"><div class="card-header">{{ __('Historial de peticiones')}}</div></div>
                ...
                <div class="card-body">
                    ...
                    <div class="contenidopeticionespendientes">
                        @if($peticiones->isEmpty())  
                            <div class="peticionespendientesvacio"><p>No hay peticiones antiguas registradas</p></div>  <!-- Mensaje que se muestra en caso que no haya peticiones antiguas -->
                        @else
                            <ul>
                                        ...
                                        <li>
                                            ...
                                            <div class="resolucion">
                                                @if($peticion->status == 'aceptada')
                                                    <p style="color:green; font-weight:bold">Aceptada</p>
