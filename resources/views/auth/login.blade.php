...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card encabezado"><div class="card-header">{{ __('Iniciar Sesion')}}</div></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" value="admin123" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
